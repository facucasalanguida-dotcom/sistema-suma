...
import { BrandRule, SumaPdfLogo } from './logo';
import { pdfText } from './text';
import { brandColors, company } from '@/lib/brand';
 ...
 *
 * Se usan las tipografías estándar del formato PDF (Helvetica) para que el
 * documento no dependa de ningún archivo externo. Para usar la tipografía
 * corporativa, registrar el TTF con `Font.register` y sustituir `fontFamily`.
 */
...
const styles = StyleSheet.create({
  ...
  headerMeta: { fontSize: 8, color: brandColors.inkMuted, marginTop: 2 },

  /* Bloques de datos ----------------------------------------------------- */
  panels: { flexDirection: 'row', gap: 12, marginTop: 14 },
  panel: {
    flex: 1,
    borderWidth: 1,
  ...
  panelAccent: { backgroundColor: brandColors.primaryTint, borderColor: brandColors.primaryTint },
  panelTitle: {
    fontFamily: 'Helvetica-Bold',
    fontSize: 7.5,
    letterSpacing: 1.1,
  ...
  panelLine: { fontSize: 8.5, color: brandColors.inkMuted, lineHeight: 1.45 },
  ...
  productMeta: { fontSize: 7.5, color: brandColors.inkMuted, marginTop: 2, lineHeight: 1.35 },
  productCalc: { fontSize: 7, color: brandColors.primarySoft, marginTop: 3, lineHeight: 1.35 },
  ...
  totalLabel: { fontSize: 9, color: brandColors.inkMuted },
  totalValue: { fontSize: 9 },
  totalDivider: { height: 1, backgroundColor: brandColors.border, marginVertical: 3 },
  grandTotal: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    alignItems: 'center',
  ...
  callout: {
    ...
    backgroundColor: brandColors.accentTint,
    borderRadius: 3,
  },
  calloutTitle: {
    fontFamily: 'Helvetica-Bold',
  ...
  calloutText: { fontSize: 7.5, color: brandColors.ink, lineHeight: 1.45 },

  conditions: { marginTop: 16 },
  conditionItem: { flexDirection: 'row', marginBottom: 3 },
  conditionBullet: { width: 10, fontSize: 8, color: brandColors.accent },
  conditionText: { flex: 1, fontSize: 7.8, color: brandColors.inkMuted, lineHeight: 1.45 },
  ...
  signatureRule: { borderTopWidth: 1, borderTopColor: brandColors.ink, paddingTop: 4 },
  signatureHint: { fontSize: 7, color: brandColors.inkMuted },
  ...
  compactHeaderText: { fontSize: 8, color: brandColors.inkMuted },
  ...
  footerRule: { height: 2, backgroundColor: brandColors.accent, width: 40, marginBottom: 6 },
  footerRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end' },
  footerText: { fontSize: 6.8, color: brandColors.inkMuted, lineHeight: 1.5 },
  footerPage: { fontSize: 7, color: brandColors.inkMuted },
});
